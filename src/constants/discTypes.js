...
import result2Image from "../assets/img/result2.png";
import result3Image from "../assets/img/result3.png";
import result4Image from "../assets/img/result4.png";
...
export const DISC_DATA = [
  {
    ...
    tips: "The Winner, D 타입과 함께 일할 땐\n✔️ 간단 명료하게 요점만 전하세요.\n✔️ 자율성에 니즈가 있는편! 존중해주세요.\n✔️ 규칙, 기대치, 목표값이 명확해야 해요.\n✔️ 그들이 자발적으로 시작할 수 있도록 해보세요.",
    image: dImage,
    detailImage: dmImage,
    resultImage: result1Image,
  },
  {
    id: "i",
    type: DISC_TYPES.I,
  ...
  },
  {
    ...
    tips: "The Peacekeeper, S 타입과 함께 일할 땐\n✔️ 지속적으로 안정감을 느낄 수 있도록 해야 해요.\n✔️ 규칙, 기대치, 목표값이 명확해야 해요.\n✔️ 진실하고 진정한 감사 표현을 잊지 마세요.",
    image: sImage,
    detailImage: smImage,
...
export const DISC_COLORS = [
  "rgba(187, 228, 166, 1)", // D - 녹색
  "rgb(243, 247, 147)", // I - 노란색
  "rgba(190, 203, 252, 1)", // S - 파란색
  "rgba(241, 166, 239, 1)", // C - 분홍색
];
